...
import com.project.exception.UsersDaoException;
...
public class UsersImplDao implements UsersDao {
    ...
    private static volatile UsersImplDao INSTANCE;
    private static final RolesImplDao roleDao = RolesImplDao.getInstance();
    ...
    private UsersImplDao() {
    }

    public static UsersImplDao getInstance() {
        if (INSTANCE == null) {
            synchronized (UsersImplDao.class) {
                if (INSTANCE == null) {
                    INSTANCE = new UsersImplDao();
                }
            }
        }
        return INSTANCE;
