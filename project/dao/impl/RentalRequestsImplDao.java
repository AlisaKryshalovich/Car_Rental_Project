...
import com.project.dao.RentalRequestsDao;
...
import com.project.exception.CarsDaoException;
import com.project.exception.RentalRequestsDaoException;
...
public class RentalRequestsImplDao implements RentalRequestsDao {

    private static volatile RentalRequestsImplDao INSTANCE;

private final CarsImplDao carDao = CarsImplDao.getInstance();
private final UsersImplDao usersDao = UsersImplDao.getInstance();
...
private RentalRequestsImplDao() {}

    public static RentalRequestsImplDao getInstance() {
        if (INSTANCE == null) {
            synchronized (RentalRequestsImplDao.class) {
                if (INSTANCE == null) {
                    INSTANCE = new RentalRequestsImplDao();
                }
            }
        }
        return INSTANCE;
    ...
    @Override
    public Optional<RentalRequestsEntity> findById(Integer id) {
        try (Connection connection = ConnectionManager.getConnection();
            ...
            throw new RentalRequestsDaoException(e);
        }
    }

    private RentalRequestsEntity buildRentalRequest(ResultSet resultSet) throws SQLException {
        return new RentalRequestsEntity(
    ...
    @Override
    public RentalRequestsEntity save(RentalRequestsEntity rentalRequest) {
        try (Connection connection = ConnectionManager.getConnection();
    ...
    @Override
    public void update(RentalRequestsEntity rentalRequest) {
        try (Connection connection = ConnectionManager.getConnection();
