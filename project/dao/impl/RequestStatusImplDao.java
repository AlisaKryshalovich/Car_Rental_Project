...
import com.project.dao.RequestStatusDao;
...
public class RequestStatusImplDao implements RequestStatusDao {
    ...
    public RequestStatusEntity save(RequestStatusEntity status) {
        try (Connection connection = ConnectionManager.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(CREATE_REQUEST_STATUS_SQL, Statement.RETURN_GENERATED_KEYS)) {
